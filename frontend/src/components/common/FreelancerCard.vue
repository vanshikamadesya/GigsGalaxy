...
<style lang="scss" scoped>
  ...
  .fl-card {
    ...
    &:hover { transform: translateY(-4px); box-shadow: $shadow-xl !important; }
  }

  .fl-card-body { padding: $spacing-lg !important; }
  ...
  .fl-skill-chip { border-radius: $radius-full !important; }

  .fl-stat-value { font-weight: 700; font-size: $font-size-sm; color: $primary; }
  .fl-stat-label { font-size: 11px; color: $text-muted; }
</style>
