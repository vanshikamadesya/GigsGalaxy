...
<style lang="scss" scoped>
  ...
  .summary-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid $border-color; font-size: $font-size-sm; .body--dark & { border-bottom-color: $border-color-dark; } &:last-child { border-bottom: none; } }
  .requirement-item { padding: $spacing-sm; background: $bg-light; border-radius: $radius-sm; .body--dark & { background: rgba(255,255,255,0.04); } }
